      ...
      <el-card header="商品明细" class="mt10">
        <div class="receipt-order-content">
          ...
          <el-table :data="form.details" border empty-text="暂无商品明细">
            ...
            <el-table-column label="容器号" width="160" align="center">
              <template #default="scope">
                <el-input v-model="scope.row.containerNo" placeholder="容器号(选填)"></el-input>
              </template>
            </el-table-column>
            <el-table-column label="起点库位" width="160" align="center">
              <template #default="scope">
                <el-input v-model="scope.row.sourceLocation" placeholder="起点库位(选填)"></el-input>
              </template>
            </el-table-column>
            <el-table-column label="目标库位号" width="160" align="center">
              <template #default="scope">
                <el-input v-model="scope.row.targetLocation" placeholder="目标库位号(选填)"></el-input>
              </template>
            </el-table-column>
...
const handleCancelRcsTask = async () => {
  await proxy?.$modal.confirm('确认撤销该移库单关联的 RCS 任务吗？');
